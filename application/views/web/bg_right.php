<div id="content-right">
	<div class="sidebar-widget">
		<section class="sidebar-widget-header"><h3>Keranjang Belanja Anda</h3></section>
	...
	<div class="sidebar-widget">
		<section class="sidebar-widget-header"><h3>Produk Terbaru Bulan Ini</h3></section>
	...
	<div class="sidebar-widget">
		<section class="sidebar-widget-header"><h3>Testimonial Pengunjung</h3></section>
		<section class="sidebar-widget-content">
	...
	<div class="sidebar-widget">
		<section class="sidebar-widget-header"><h3>Jasa Pengiriman Barang</h3></section>
		<section class="sidebar-widget-content">
			<div id="sub-content-center">
